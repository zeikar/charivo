    ...
    <div className="absolute inset-x-3 bottom-26 md:top-20 md:left-8 md:right-auto md:bottom-auto z-10 space-y-2.5 md:space-y-3 pointer-events-none">
      {visibleMessages.map((message, index, arr) => {
        ...
        return (
          ...
          >
            <div className="relative inline-block px-4 py-2.5 md:px-5 md:py-3 rounded-[1.6rem] md:rounded-2xl shadow-lg md:shadow-md bg-white/96 dark:bg-gray-700/96 text-gray-800 dark:text-white border border-gray-200 dark:border-gray-600 max-w-[min(20rem,calc(100vw-3rem))] md:max-w-md backdrop-blur-sm">
      ...
      {showLiveDraft && (
        <div className="md:block flex justify-center md:justify-start">
          <div className="relative inline-block px-4 py-2.5 md:px-5 md:py-3 rounded-[1.6rem] md:rounded-2xl shadow-lg md:shadow-md bg-blue-50/96 dark:bg-blue-950/60 text-gray-800 dark:text-white border border-blue-200 dark:border-blue-800 max-w-[min(20rem,calc(100vw-3rem))] md:max-w-md backdrop-blur-sm">
      ...
      {showInterruptedDraft && (
        <div className="md:block flex justify-center md:justify-start">
          <div className="relative inline-block px-4 py-2.5 md:px-5 md:py-3 rounded-[1.6rem] md:rounded-2xl shadow-lg md:shadow-md bg-amber-50/95 dark:bg-amber-950/40 text-gray-700 dark:text-amber-50 border border-amber-200 dark:border-amber-800/80 max-w-[min(20rem,calc(100vw-3rem))] md:max-w-md opacity-90 backdrop-blur-sm">

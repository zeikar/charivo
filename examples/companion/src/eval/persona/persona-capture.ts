 ...
 *      stands in for the voice-native gpt-realtime-2.1-mini; advisory only, not a voice fidelity
 *      test).
...
export function writeArtifact(args: {
  ...
  lines.push(
    ...
    "> or `$PERSONA_EVAL_MODEL`), NOT the voice-native `gpt-realtime-2.1-mini`. This is",

...
describe("createSessionCap", () => {
   ...
   * call that starts it, before the session refs and UI state the teardown acts
   * on are assigned. Only the teardown current at fire time actually stops the
   * session and surfaces the notice.
   */

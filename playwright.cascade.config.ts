...
export default defineConfig({
  ...
  webServer: {
    ...
    url: baseURL,
    // Never reuse: the harness fixes its STT, LLM, and TTS providers from
    // CASCADE_STT, CASCADE_LLM, and CASCADE_TTS when the vite config loads,
    // so a leftover server could silently run the wrong one.

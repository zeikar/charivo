...
assistant lifecycle events until it reports. The low-level transport also covers
a client-requested response interrupted before its acknowledgement, and repeated
interrupt-and-replace cycles, which a single suppression flag could not survive.

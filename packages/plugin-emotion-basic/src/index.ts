...
export type Emotion = 'happy' | 'sad' | 'angry' | 'surprised' | 'neutral' | 'excited'
...
export class BasicEmotionPlugin implements EmotionPlugin {
  ...
  analyzeEmotion(message: Message): EmotionData {
    ...
    if (content.includes('happy') || content.includes('joy') || content.includes('😊')) {
      emotion = 'happy'
      intensity = 0.8
    } else if (content.includes('sad') || content.includes('😢')) {
      emotion = 'sad'
      intensity = 0.7
    } else if (content.includes('angry') || content.includes('mad') || content.includes('😠')) {
      emotion = 'angry'
      intensity = 0.9
    } else if (content.includes('surprised') || content.includes('wow') || content.includes('😲')) {
      emotion = 'surprised'
      intensity = 0.8
    } else if (content.includes('excited') || content.includes('amazing') || content.includes('😃')) {
      emotion = 'excited'
      intensity = 0.9
    }
